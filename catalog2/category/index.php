...
if(isset($_GET['c'])){
	...
	$query	 = "SELECT Product_Group FROM products_june WHERE System='$pg' GROUP BY Product_Group ORDER BY Product_Group ASC";
		...
		<div id="tableless">
			<div id="container">
					...
					<div class="inner">
						<div class="bannernavigation">
							<span class="inner">
								...
								<a href="/faq/default.php">&nbsp;FAQ&nbsp;</a>
								<a href="../../contact-us/default.php">Contact Us</a>
								<a href="../../case-studies/default.php">Case Studies</a>
							</span>
						</div>
						<div style="clear:both"></div>
						<span>
							<img src="../../images/spacer(8hkxt2).gif" width="720" height="10" />
						</span>
						<a href="../../index.php">
							<img alt="" class="cmx-FloatLeft logo" src="../../images/logo(ss5sr2).jpg" width="218" height="122" />
						</a>
						<span class="marketing-message-bucket">
							<span class="marketing-message-sub">
								<a href="../../index.php">Industrial Adhesive and<br />Sealant Dispensing</a>
							</span>
							<span class="tag-line-sub">
								<a href="../../index.php">Precision Systems for Meter, <br />Mix and Dispense Applications</a>
							</span>
							<div style="clear:both"></div> 
							<span class="print-address">
								<p>Kirkco Corporation<br />P.O. Box 509<br />Monroe, NC 28111<br /><br />Phone: (704) 289-7090<br />Fax: (704) 289-7091</p>
							</span>
						</span>
				...
				<div id="left">
					<div class="inner">
						<div id="leftcontent">
							<span class="left-bucket">
								<span class="products">
									<span class="left-header">
										<a href="../../products/default.php">Products by Category</a>
									...
									<span class="product-links">
										<ul>
											...
											<li><a href="../../products/cold-glue-adhesive-systems/default.php">Cold Glue Adhesive Systems</a></li>
										</ul>
									</span>
								</span>
								<span class="left-navigation">
									<span class="left-header">
										<a href="../../services/default.php">Services</a>
									</span>
									<span class="left-navigation-text"><p>Factory Trained Service Assistance, Training and Repairs.</p>
										<ul>
											<li><a href="../../services/in-field-installation/default.php">In Field Installation </a></li>
											<li><a href="../../services/training-and-education/default.php">Training &amp; Education </a></li>
											<li><a href="../../services/rebuild-and-repair/default.php">Rebuild &amp; Repair </a></li>
										</ul>
									</span>
								</span>
								<span class="left-navigation">
									...
									</span><p>Leading Manufacturers of Hot and Cold, Single or Plural Component Adhesive Metering and Dispensing Units.</p>
									<ul>
										<li><a href="../../approved-vendors/abb-robotics/default.php">ABB Robotics</a> </li>
										<li><a href="../../approved-vendors/hilger-u-kern-dopag-group/default.php">Hilger u Kern / Dopag Group</a> </li>
										<li><a href="../../approved-vendors/graco/default.php">Graco</a> </li>
										<li><a href="../../approved-vendors/itw-dynatec/default.php">ITW-Dynatec</a> </li>
										<li><a href="../../approved-vendors/walther-pilot/default.php">Walther Pilot </a></li>
								...
								<span class="left-navigation">
									...
									<ul>
										<li><a href="../../case-studies/default.php">Learn More</a></li></ul></span></span></div></div></div><div id="main"><div class="inner"><div id="maincontent">
							...
							<h1><?PHP echo dunderscore($_GET['c']); ?></h1>
							<span class="content">
								<?php
								if(!empty($s1array)){
									echo '<h2>SubCategories</h2><ul>';

									foreach($s1array as $A){
										echo '<li><a href="/catalog2/subdetail/'.$pg.'/'.underscore($A).'.html">'.$A.'</a></li>';
									}
									echo '</ul>';
								}

								$pg		 = dunderscore($_GET['c']);
								$query	 = "SELECT item, ItemID, Subone,`Master_Item_Part_No`,`Short_Description` FROM products_june WHERE System='$pg' ORDER BY Photo DESC, item ASC";
								$result	 = mysql_query($query); // Run the query.
								...
								while($row = mysql_fetch_array($result, MYSQL_ASSOC)){
									...
									echo '<a href="/catalog2/detail/'.underscore($row['Master_Item_Part_No']).'.html">'.$in.'</a><br />'.$row['Short_Description'].'<br />';
								}
								?>
							</span>
							<!-- InstanceEndEditable -->
				...
				<div id="footer">
					<div class="inner">
						...
						<span class="copyrightnotice">
							...
							<span>Kirkco Corporation, P.O. Box 509, Monroe, NC 28111</span>

						</span>By Networks Marketing Group: <a href="http://www.networksmarketinggroup.com/">Charlotte NC Internet Marketing</a>
					</div>
				</div>
				<div style="clear:both"></div>
				<div id="right">
					<div class="inner">
						<div id="rightcontent">
							<span class="rightcontent">
								<div class="cmxvspace" style="height:28px"></div>
								<div style="clear:both"></div>
								<h2 style="padding-top:5px;">Search:</h2>
								<span>
									<form name="frmSearchBox" action="/ssearch/search.php" method="post">
										<input type="hidden" value="" name="path"/>
										<input type="hidden" value="0" name="refine"/>
										<input type="hidden" value="custom.html" name="template_demo"/>
										<input type="hidden" value="search.php" name="result_page"/> 
										<input type="text" name="query_string" id="keyword" />
										<input type="submit" value="Go"/><br />&nbsp;
									</form>
								</span>
								<div class="cmxvspace" style="height:26px"></div>
								<div style="clear:both"></div> 
								<span class="calls-to-action">
									<ul>
										...
										<li><a href="../../engineering-request/default.php">Engineering Request</a></li>
									</ul>
								</span>
								<div style="clear:both"></div> 
								<a href="javascript:cmxPrint()">
									<img alt="" src="../../images/print-icon(aqjd82).gif" width="15" height="15" class="print-icon" />
								</a>
								<span class="print-text"><a href="javascript:cmxPrint()">View Printable Version</a></span>
							</span>
						</div>
					</div>
				</div>
